...
public class LoanControllerTest {
    ...
    @DisplayName("Test get loan into by id equals 1 should return loan information")
    @Test
    ...
    @DisplayName("Test get loan into by id equals 2 should return loan Exception Loan info not found")
    @Test
    void testGetLoanInfoByIdEquals2()throws Exception {
        Long reqParam= 2L;
        when(loanService.getLoanInfoById(reqParam))
                .thenThrow(
                        new LoanException(
    ...
    @DisplayName("Test get loan into by id equals 3 should throw Exception :Test throw new exception")
    @Test
    void testGetLoanInfoByIdEquals3()throws Exception{
        Long reqParam= 3L;
        when(loanService.getLoanInfoById(reqParam))
                .thenThrow(new Exception("Test throw new Exception")
                );
